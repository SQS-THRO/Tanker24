...
class Station(Base):
    ...
    owner: Mapped[User] = relationship(
        back_populates="stations", lazy="selectin"
    )
...
class Car(Base):
    ...
    history_records: Mapped[list["HistoryRecord"]] = relationship(
        back_populates="car", lazy="selectin"
    )
...
class FuelType(Base):
    ...
    history_records: Mapped[list["HistoryRecord"]] = relationship(
        back_populates="fuel_type", lazy="selectin"
    )
...
class HistoryRecord(Base):
    ...
    car: Mapped[Car] = relationship(
        back_populates="history_records", lazy="selectin"
    )

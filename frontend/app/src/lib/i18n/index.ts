export const translations = {
	en: {
		...
		impressum: {
			...
			reasoningText: 'This Project is an PSTA from the SQS Course of the University of Applied Sciences in Rosenheim. Therefore any legal regards shall be communicated via the University'
			},
		privacy: {
			...
			retention: 'The data will be deleted as soon as it is no longer necessary for the purpose for which it was collected. In the case of the collection of data for the provision of the website, this is the case when the respective session has ended.',
	...
	de: {
		...
		impressum: {
			...
			reasoningText: 'Dieses Projekt ist eine PSTA aus dem SQS Kurs der Technischen Hochschule Rosenheim. Jegliche rechtliche Belangen sollen daher über die Hochschule geklärt werden'
		},
		privacy: {
			...
			collection: 'Diese Website wird von einem Team von Studenten der Technischen Hochschule Rosenheim im Rahmen eines Hochschulprojekts betrieben. Wenn Sie unsere Website besuchen, werden automatisch Informationen an den Server unserer Website gesendet. Diese Informationen werden vorübergehend in Logdateien gespeichert. Folgende Daten werden ohne Ihr Zutun erfasst und bis zur automatischen Löschung gespeichert: IP-Adresse des anfordernden Rechners, Datum und Uhrzeit des Zugriffs, Name und URL der abgerufenen Datei, Website, von der aus der Zugriff erfolgt (Referrer-URL), verwendeter Browser und ggf. das Betriebssystem Ihres Rechners sowie der Name Ihres Access-Providers.',
			...
			retention: 'Die Daten werden gelöscht, sobald sie für die Erreichung des Zweckes ihrer Erhebung nicht mehr erforderlich sind. Im Falle der Erfassung der Daten zur Bereitstellung der Website ist dies der Fall, wenn die jeweilige Sitzung beendet ist.',
